...
import { getDocGroups, type DocEntry } from '@/docs/registry'
...
export function DocumentationPage() {
  ...
  const groups = getDocGroups(locale, t)
              ...
              {group.docs.map((doc) => (
                <li key={doc.slug}>
                  <button
                    ...
                    className="flex w-full items-center gap-3 px-4 py-3 text-start transition-colors hover:bg-on-surface/5"
                  >
